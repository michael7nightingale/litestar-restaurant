...
async def forwards():
    ...
    manager.add_column(
        table_class_name="Product",
        tablename="product",
        column_name="has_ingredients",
        db_column_name="has_ingredients",
        column_class_name="Boolean",
        column_class=Boolean,
        params={
            "default": True,
    ...
    manager.add_column(
        table_class_name="Product",
        tablename="product",
        column_name="caloricity",
        db_column_name="caloricity",
        column_class_name="Integer",
        column_class=Integer,
        params={
            "default": 0,
